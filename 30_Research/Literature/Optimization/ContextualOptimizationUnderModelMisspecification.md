...
在上述假设下, 有如下定理:
***Theorem 3*** 在 Assumptions 2, 3 和 5 下, 存在 $\alpha > 0$, 使得对于任意固定的 $u > 0$、任意满足 $\|\theta\|_2 \geq u$ 的 $\theta \in \mathbb{R}^m$, 以及任意 $\beta \geq \beta^\star_{\mathcal{H}, \mathcal{P}}$, 有
$$
