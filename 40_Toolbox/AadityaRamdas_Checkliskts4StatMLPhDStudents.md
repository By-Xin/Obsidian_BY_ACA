...
(Also check out the checklists for Stat-ML Assistant Professors)

https://stat.cmu.edu/~aramdas/checklists.html
...
The aim of the following checklists is primarily:
    ...
    For me to structure my advice to my new students, so that I'm not leaving it to memory each time.

    For my students to structure their self-reflection on their progress, and recall some of my advice.

However, there are potential side-benefits:

    It might help students in other universities who do not have easy access to such resources.

    It might help advisors who may not have the time to create such checklists themselves.
...
Starting out:
    ...
    What to ask your potential advisor? (not mine)

    Maintaining work-life balance in a Stat-ML PhD

    A primer on using git
...
In the middle:
    ...
    How to seek help at CMU

    Delivering an effective Stat-ML talk

    Writing technical Stat-ML papers, or you could follow Calvin's advice instead

    Navigating Stat-ML conferences or workshops

    Reviewing submitted Stat-ML papers

    Designing a Stat-ML poster

    Writing effective Stat-ML rebuttals

At the end:

    Faculty job market timeline

    Tips for theses and defenses (not mine)

    Why do a postdoc, and why with me?

    Tips for job interviews (not mine)
...
Job listings:
    ...
    MathJobs (Math/Stat/CS)

    UF Listing (Stat)

    UW Listing (Stat)

    AcademicJobsOnline (All)
...
To be written:
    ...
    Interview travel checklist (what to pack)

    The difference between work-life balance and work-life separation

    The value of non-screen-based hobbies

    The parallels between entrepreneurship and a tenure-track professorship
